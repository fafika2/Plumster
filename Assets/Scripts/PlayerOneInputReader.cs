...
[CreateAssetMenu(fileName = "PlayerOneInputReader", menuName = "Scriptable Objects/PlayerOneInputReader")]
public class PlayerOneInputReader : ScriptableObject, IPlayerOneActions
{
    ...
    private void OnEnable()
    {
        ...
        if (inputSystemActions == null)
        {
            ...
            inputSystemActions.PlayerOne.SetCallbacks(this);
        }
